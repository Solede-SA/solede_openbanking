...
### Fixed
- Remove .github/README.md that was conflicting with main README display on GitHub
...
[1.0.2]: https://github.com/Solede-SA/solede_openbanking/releases/tag/v1.0.2
